...
//	}
    ...
    m_conv[10].init(m_conv[9].szOut(), 1024, 1, 512, ct::Size(1, 1), gpumat::LEAKYRELU, false, true, true);
    m_conv[11].init(m_conv[10].szOut(), 512, 1, 256, ct::Size(1, 1), gpumat::LEAKYRELU, false, true, true);
    m_conv[12].init(m_conv[11].szOut(), 256, 1, 128, ct::Size(1, 1), gpumat::LEAKYRELU, false, true, true);
