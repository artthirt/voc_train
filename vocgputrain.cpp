...
//	}
    ...
    m_conv[9].init(m_conv[8].szOut(), 1024, 1, 1024, ct::Size(1, 1), gpumat::LEAKYRELU, false, true, true);
    m_conv[10].init(m_conv[9].szOut(), 1024, 1, 512, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[11].init(m_conv[10].szOut(), 512, 1, 256, ct::Size(1, 1), gpumat::LEAKYRELU, false, true, true);
    m_conv[12].init(m_conv[11].szOut(), 256, 1, 128, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[13].init(m_conv[12].szOut(), 128, 1, Classes + Boxes + Rects, ct::Size(1, 1), gpumat::LINEAR, false, false, true);
